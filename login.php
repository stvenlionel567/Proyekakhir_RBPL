...
<body class="login" style="overflow: hidden; backgrounf-color: #ffffff;"> 
  <div class="center ms-5 pt-5" style=" border: solid 1px #ffffff80; width: 30%; left:47%;">
    <h1 class="pb-0 " style="font-weight: bolder; font-family: inter;">LOGIN</h1>
    <form method="POST">
      <div class="txt_field">
      ...
      <a href="forgot-password.php" style="text-decoration: none; color: #000000; margin-bottom: 10px; font-size: 13px;">Lupa Sandi?</a>
      <button class="button btn-inti mt-2" name="login" id="login" style="background-color: #000000;">Login</button>
      <div class="signup_link">
        Belum punya akun? <a href="user/daftar.php" style=" color: #65B741 !important;">Daftar</a>
      </div>
    </form>
  </div>
</body>
