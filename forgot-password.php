...
<body class="login" style="overflow: hidden; backgrounf-color: #ffffff;"> 
  <div class="center ms-5 pt-3" style=" border: solid 1px #ffffff80; width: 30%; left:47%;">
    <h1 class="pb-0 " style="font-weight: bolder; font-family: inter; font-size:25px;">Lupa Sandi</h1>
    <h6 class="pb-0 text-center" style="font-family: montserrat; font-size:12px;">Masukan Email yang Pernah terdaftar</h6>
    <form method="POST" action="cek.php">
      ...
      <button type="submit" class="btn btn-inti mb-4" name="resetpass" id="resetpass" style="background-color: #000000; width: 100%; color:#ffffff; font-weight: bold; font-size: 12px;">Cek Email</button>
    </form>
  </div>
</body>
